...
<!-- Classify music excerpts from the GTZAN dataset using  Convolutional Neural Networks.  -->
...
![CNN64 - Training and Validation Accuracy per epoch]({{ site.baseurl }}/images/cnn64_hist.png)
